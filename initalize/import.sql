...
INSERT INTO `role` (`roleid`, `code`, `label`, `createddate`, `createdby`, `lastmodifieddate`, `lastmodifiedby`) VALUES ('0000000001', 'ROLE_USER', '一般用戶', CURRENT_TIMESTAMP, '0000000000', CURRENT_TIMESTAMP, '0000000000');
